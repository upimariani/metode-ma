...
class cLaporan extends CI_Controller
{
	...
	public function lap_harian_transaksi()
	{
		...
		$pdf->Cell(200, 40, 'LAPORAN HASIL BAHAN BAKU TRANSAKSI HARIAN', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
		...
		foreach ($data as $key => $value) {
			...
			$pdf->Cell(50, 6, $value->id_tran_bb, 1, 0);
			$pdf->Cell(30, 6, $value->tgl_tran, 1, 0);
			$pdf->Cell(60, 6, $value->nama_bb, 1, 0);
			$pdf->Cell(40, 6, 'Rp.' . number_format($value->harga * $value->jml), 1, 1);
		}
		$pdf->Output();
	}
	public function lap_bulanan_transaksi()
	{
		...
		$pdf->Cell(200, 40, 'LAPORAN HASIL TRANSAKSI BAHAN BAKU BULANAN', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
		$pdf->SetFont('Times', 'B', 9);
		$pdf->Cell(10, 7, 'No', 1, 0, 'C');
	...
	public function lap_tahunan_transaksi()
	{
		...
		$pdf->Cell(200, 40, 'LAPORAN HASIL TRANSAKSI BAHAN BAKU TAHUNAN', 0, 0, 'C');
		$pdf->SetLineWidth(0);
		$pdf->Cell(10, 30, '', 0, 1);
		$pdf->SetFont('Times', 'B', 9);
		$pdf->Cell(10, 7, 'No', 1, 0, 'C');
