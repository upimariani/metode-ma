							...
							<li class="nav-item nav-profile dropdown">
								<a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
									...
									<div class="nav-profile-text">
										<p class="text-black font-weight-semibold m-0"> Produksi Perusahaan </p>
			...
			<nav class="bottom-navbar">
				<div class="container">
					<ul class="nav page-navigation">
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Produksi/cDashboard') ?>">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Produksi/cBahanJadi') ?>">

								<i class="mdi mdi-archive menu-icon"></i>
								<span class="menu-title">Bahan Jadi</span>
							</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Produksi/cBBKeluar') ?>">
								<i class="mdi mdi-arrow-up-bold-circle menu-icon"></i>
								<span class="menu-title">Bahan Baku Keluar</span>
							</a>
						</li>
