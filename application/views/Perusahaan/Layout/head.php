							...
							<li class="nav-item nav-profile dropdown">
								<a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
									...
									<div class="nav-profile-text">
										<p class="text-black font-weight-semibold m-0"> Admin Perusahaan </p>
			...
			<nav class="bottom-navbar">
				<div class="container">
					<ul class="nav page-navigation">
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Perusahaan/cDashboard') ?>">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Perusahaan/cUser') ?>">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('Perusahaan/cTransaksiBB') ?>">
