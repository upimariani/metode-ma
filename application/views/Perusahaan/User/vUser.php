		...
		<div class="content-wrapper pb-0">
			<div class="page-header flex-wrap">
				...
				<div class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
					...
					<a href="<?= base_url('Perusahaan/cUser/create') ?>" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<a href="<?= base_url('Perusahaan/cUser/update/' . $value->id_user) ?>" class="btn btn-outline-secondary btn-icon-text"> Edit <i class="mdi mdi-file-check btn-icon-append"></i></a>
													<a href="<?= base_url('Perusahaan/cUser/delete/' . $value->id_user) ?>" class="btn btn-outline-warning btn-icon-text"><i class="mdi mdi-reload btn-icon-prepend"></i> Hapus </a>
												</td>
											</tr>
										<?php
										}
