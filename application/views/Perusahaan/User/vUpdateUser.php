		...
		<div class="content-wrapper">
			...
			<div class="row">
				...
				<div class="col-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<form action="<?= base_url('Perusahaan/cUser/update/' . $user->id_user) ?>" method="POST" class="forms-sample">
								<div class="form-group">
									<label for="exampleInputName1">Nama User</label>
									<input type="text" name="nama" class="form-control" value="<?= $user->nama_user ?>" id="exampleInputName1" placeholder="Masukkan Nama User" />
