		...
		<div class="content-wrapper">
			...
			<div class="row">
				...
				<div class="col-12 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							<form action="<?= base_url('Perusahaan/cUser/create') ?>" method="POST" class="forms-sample">
								...
								<div class="form-group">
									...
									<input type="number" name="deskripsi" class="form-control" id="exampleInputPassword4" placeholder="Masukkan Deskripsi" />
								...
								<div class="form-group">
									...
									<input type="file" name="gambar" class="form-control" id="exampleInputCity1" required />
